      ...
      <div className="mb-8">
        <div className="flex flex-col items-center font-medium mt-16 mb-12 px-12 mx-auto max-w-[550px] ">
          ...
          <div className="text-center text-lg mb-8 md:text-xl">
            10x your financial job interviews by applying with Fintervue.
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-end justify-center pb-20 gap-8">
          <div className="shadow-xl border-gray-100 border-2 rounded-2xl p-8">
            ...
            <div className="flex flex-col gap-6">
              <div>
                <IoMdCheckmark className="inline mr-2" /> Up to 3 AI interviews
              </div>
              <div>
          ...
          <div className="shadow-2xl border-2 rounded-2xl p-8 bg-black text-white">
            ...
            <div className="flex flex-col gap-6">
              <div>
                <IoMdCheckmark className="inline mr-2" /> Up to 50 virtual
                interviews
              </div>
              <div>
                <IoMdCheckmark className="inline mr-2" /> Unlimited tasks and
              ...
              <div>
                <IoMdCheckmark className="inline mr-2" /> Application Kit
              </div>
              <div>
                <IoMdCheckmark className="inline mr-2" /> Advanced support
              </div>
              <div>
                <IoMdCheckmark className="inline mr-2" /> Interview Buddy (soon)
              </div>
            </div>
          </div>
          <div className="shadow-xl border-gray-100 border-2 rounded-2xl p-8">
            ...
            <div className="flex flex-col gap-6">
              <div>
                <IoMdCheckmark className="inline mr-2" /> Up to 50 project
                members
              </div>
              <div>
                <IoMdCheckmark className="inline mr-2" /> Unlimited tasks and
              ...
              <div>
                <IoMdCheckmark className="inline mr-2" /> Resume Translator
              </div>
              <div>
