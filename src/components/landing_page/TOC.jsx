    ...
    <div>
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="text-center text-1xl pb-5 mt-1 mb-1 md:text-1xl">
          <h3>
            Hire top talent screened and interviewed by AI, stamped by industry
            experts.
          </h3>
        </div>
        <div className="flex flex-wrap justify-center gap-8 mb-8">
          ...
          <div className="flex flex-col items-center text-center p-6 border rounded-lg shadow-lg max-w-xs transform transition-transform duration-300 hover:scale-105 hover:bg-gray-100">
            ...
            <p className="text-sm text-gray-600">
              Interviewers must respect the privacy of interviewees by not
              sharing or disclosing any personal information, interview
              responses, or other sensitive data without explicit consent.
            </p>
          </div>
          <div className="flex flex-col items-center text-center p-6 border rounded-lg shadow-lg max-w-xs transform transition-transform duration-300 hover:scale-105 hover:bg-gray-100">
            <svg
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-8">
          ...
          <div className="flex flex-col items-center text-center p-6 border rounded-lg shadow-lg max-w-xs transform transition-transform duration-300 hover:scale-105 hover:bg-gray-100">
            ...
            <p className="text-sm text-gray-600">
              Interviewees should maintain a courteous and respectful tone
              during the interview, avoiding any inappropriate language or
              behavior.
            </p>
          </div>
        </div>
