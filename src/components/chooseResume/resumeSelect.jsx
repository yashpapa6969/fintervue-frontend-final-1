  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4">
        ...
        {/* Steps Navigation */}
        <div className="flex justify-between items-center p-4 mb-4 mt-6 "> {/* rounded-lg shadow-lg */}
          <div className="">
            <FlipText
          ...
          <div className="flex items-center w-full justify-center relative space-x-8">
            {/* Step 1 Indicator */}
            <div className="relative flex flex-col items-center">
              <div
                className={`flex items-center justify-center w-14 h-14 rounded-full text-lg font-bold transition-all duration-500 ${
                  step >= 1 ? "bg-blue-700 text-white scale-110 shadow-lg" : "border-2 border-blue-700 text-blue-700"
                }`}
              >
                1
              </div>
              <span className={`mt-3 text-sm font-medium ${step >= 1 ? "text-blue-700" : "text-gray-500"}`}>
                Choose Template
              </span>

              {/* Line to Step 2 */}
              <div
                className={`absolute top-7 left-full w-12 h-1 transform transition-all duration-500 ${
                  step >= 2
                    ? "bg-gradient-to-r from-blue-500 to-blue-700 animate-pulse"
                    : "bg-gray-300"
                }`}
              ></div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <span className={`mt-3 text-sm font-medium ${step >= 2 ? "text-blue-700" : "text-gray-500"}`}>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <span className={`mt-3 text-sm font-medium ${step >= 3 ? "text-blue-700" : "text-gray-500"}`}>
                Resume Builder
              </span>
            </div>
          </div>
        ...
        {step === 1 && (
          <div className="relative w-full">
            ...
            <button className="py-3 px-4 text-white bg-blue-700 font-bold w-full md:w-40 text-lg rounded-full transition-transform hover:scale-105 mb-6" onClick={handleNextStep}>
                Next
              </button>
            </div>
          </div>
