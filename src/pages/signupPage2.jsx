        ...
        <div className="h-screen bg-gray-50">
            ...
            <div className="flex flex-col items-center justify-center py-12">
                ...
                <div className="grid w-full grid-cols-1 gap-6 px-4 max-w-7xl md:grid-cols-3 md:px-0">
                    {/* Card 1 - Interviewer */}
                    <div className="p-6 text-center transition-transform transform bg-gray-200 rounded-lg shadow-md cursor-not-allowed opacity-60 hover:shadow-lg">
                        <div className="mb-4">
                        ...
                        <button
                            disabled
                            className="px-6 py-2 font-semibold text-white bg-yellow-300 rounded-md"
                        >
                            Login
                        </button>
                    ...
                    {/* Card 2 - Interviewee */}
                    <div className="p-6 text-center transition-transform transform bg-white rounded-lg shadow-md scale-105 hover:shadow-lg">
                        <div className="mb-4">
                    ...
                    <div className="p-6 text-center transition-transform transform bg-gray-200 rounded-lg shadow-md opacity-60 cursor-not-allowed hover:shadow-lg">
                        <div className="mb-4">
                        ...
                        <h2 className="mb-4 text-2xl font-bold">
                            For <span className="text-black">Recruiters</span>
                        </h2>
                        <p className="mb-6 text-gray-600">
